...
Desarrollador Full Stack con experiencia en la creación de aplicaciones web modernas y funcionales.
Me apasiona el equilibrio entre diseño limpio y código bien estructurado.
Actualmente en búsqueda activa de mi primer reto profesional.
```typescript
const samuel = {
